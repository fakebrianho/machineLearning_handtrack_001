...
loader.load(
	...
	function (texture) {
		...
		const newMesssh = new THREE.Mesh(geometry, shaderMaterial)
		// scene.add(newMesssh)
	},
...
for (let i = 0; i < moverCount; i++) {
	let m = new Mover(Math.random(), Math.random(), 0, 15, 32, 16)
